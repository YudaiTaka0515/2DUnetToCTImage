...
def Unet2D(input_shape=(1, 512, 512), pool_size=(2, 2), n_labels=1, initial_learning_rate=0.00001, deconvolution=False,
...
def create_convolution_block(input_layer, n_filters, batch_normalization=False, kernel=(3, 3), activation=None,
    ...
    :return:
    """
    layer = Conv2D(n_filters, kernel, padding=padding, strides=strides, kernel_initializer='he_normal')(input_layer)
